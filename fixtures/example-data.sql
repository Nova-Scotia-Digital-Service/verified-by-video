BEGIN;
    ...
    INSERT INTO public.review_questions (id, review_id, question) VALUES
    ...
    INSERT INTO public.review_question_options (id, review_question_id, text, valid) VALUES
        ('153bc35d-3ae4-4746-abd4-106b12aeb187', '62333928-ade6-41c6-b131-d11efff04179', 'Yes, all prompts followed by user in the correct order', true),
        ('390641de-5288-4261-ad59-7f28b05482c0', '62333928-ade6-41c6-b131-d11efff04179', 'Didn''t follow the prompts correctly', false),
        ('287b76d4-21b4-4f5b-bfaa-1163abe5cc42', '62333928-ade6-41c6-b131-d11efff04179', 'Too low quality video/photo for matching', false),
        ('02955e84-81b2-4eb9-9aef-4913ec9e3dc8', '62333928-ade6-41c6-b131-d11efff04179', 'Couldn''t complete for other reason', false);

    INSERT INTO public.review_questions (id, review_id, question) VALUES
        ('5f816b66-d431-4642-9822-ae2dbd186e38', '532bd3f4-a0c5-4a97-87a9-19d46981747d', 'What name did they provide?');
    INSERT INTO public.review_question_options (id, review_question_id, text, valid) VALUES
        ('7d479637-c890-47fb-b879-a9c27355e776', '5f816b66-d431-4642-9822-ae2dbd186e38', 'NONPHOTO, PERCY or an acceptable variation', true),
        ('b392059a-445a-436b-8fcf-cf43a5b6b8da', '5f816b66-d431-4642-9822-ae2dbd186e38', 'Didn''t provide the correct name', false),
        ('d1ce043d-8b6d-42c2-9c03-0972a514c3ca', '5f816b66-d431-4642-9822-ae2dbd186e38', 'Couldn''t complete for other reason', false);
    ...
    INSERT INTO public.review_question_options (id, review_question_id, text, valid) VALUES
        ('a6005f55-aac0-4e26-ba67-11aff456bf5b', '9d211ed5-59c4-415d-b782-be6499205b2f', 'Yes, all match', true),
        ('0da3c0e3-6535-496b-85cc-186cc84ca767', '9d211ed5-59c4-415d-b782-be6499205b2f', 'Not all match', false),
        ('eb6f5cdf-14fc-455e-bab4-2b27e98942c9', '9d211ed5-59c4-415d-b782-be6499205b2f', 'Too low quality video or photo for matching', false),
        ('6a9a2cb0-b9a2-4959-b483-bbc6c4197593', '9d211ed5-59c4-415d-b782-be6499205b2f', 'Couldn''t complete for other reason', false);

    INSERT INTO public.review_questions (id, review_id, question) VALUES
        ('5e6fd189-c934-4049-bc00-246f2cd9c85e', '532bd3f4-a0c5-4a97-87a9-19d46981747d', 'What type of ID is provided?');
    INSERT INTO public.review_question_options (id, review_question_id, text, valid) VALUES
        ('4b85d528-a3a8-49c3-a13d-30c566c0c329', '5e6fd189-c934-4049-bc00-246f2cd9c85e', 'Nova Scotia Driver''s License', true),
        ('c694c9d7-d5f4-4024-8834-21a800c3a4be', '5e6fd189-c934-4049-bc00-246f2cd9c85e', 'Other type', false),
        ('ece94423-fb18-4aa9-8c16-6f46da09c259', '5e6fd189-c934-4049-bc00-246f2cd9c85e', 'I can''t confirm', false);

    INSERT INTO public.review_questions (id, review_id, question) VALUES
        ('957250ed-35cb-4315-a2f5-3efd4667f829', '532bd3f4-a0c5-4a97-87a9-19d46981747d', 'What number is on Nova Scotia Driver''s License?');
    INSERT INTO public.review_question_options (id, review_question_id, text, valid) VALUES
        ('64b8cfd3-6d98-40c8-af7a-1dc1c9cc4df2', '957250ed-35cb-4315-a2f5-3efd4667f829', '12121212', true),
        ('c40383be-a2c2-4eb7-8b91-93ee430efb3f', '957250ed-35cb-4315-a2f5-3efd4667f829', 'Other type', false),
        ('5254b514-30bf-4615-8db5-b8d1225b4488', '957250ed-35cb-4315-a2f5-3efd4667f829', 'I can''t confirm', false);

    INSERT INTO public.review_questions (id, review_id, question) VALUES
        ('3ea886c1-b97c-4e30-90bd-f1551df1a632', '532bd3f4-a0c5-4a97-87a9-19d46981747d', 'What is the birthdate on the ID?');
    INSERT INTO public.review_question_options (id, review_question_id, text, valid) VALUES
        ('3b1ca3d6-de80-4b27-aeff-2c8d4237088c', '3ea886c1-b97c-4e30-90bd-f1551df1a632', 'January 1, 1990', true),
        ('19a884e4-02d9-4f41-9fb6-2a7b528f3db4', '3ea886c1-b97c-4e30-90bd-f1551df1a632', 'Does not match', false),
        ('a44ee7e6-ae27-42ef-aa3e-ce9b54a3dbcf', '3ea886c1-b97c-4e30-90bd-f1551df1a632', 'I can''t confirm', false);

    INSERT INTO public.review_questions (id, review_id, question) VALUES
        ('1ae8b631-a95d-4b55-a599-aec2919096c0', '532bd3f4-a0c5-4a97-87a9-19d46981747d', 'What name is on the ID?');
    INSERT INTO public.review_question_options (id, review_question_id, text, valid) VALUES
        ('80ed0dc2-1a93-4c38-ae36-25cbc8659c53', '1ae8b631-a95d-4b55-a599-aec2919096c0', 'NONPHOTO, PERCY or an acceptable variation', true),
        ('f4b80b72-4df8-4433-bbf6-41fc80ed8455', '1ae8b631-a95d-4b55-a599-aec2919096c0', 'Does not match', false),
        ('b87e1c07-0af9-44f1-85df-e32142a8c5d3', '1ae8b631-a95d-4b55-a599-aec2919096c0', 'I can''t confirm', false);

    INSERT INTO public.review_questions (id, review_id, question) VALUES
        ('71712d42-c574-46cf-826e-f76db3a9749f', '532bd3f4-a0c5-4a97-87a9-19d46981747d', 'Is the ID valid?');
    INSERT INTO public.review_question_options (id, review_question_id, text, valid) VALUES
        ('86b271cf-6517-40ac-a11b-ae91c81dbafa', '71712d42-c574-46cf-826e-f76db3a9749f', 'Is valid, not expired', true),
        ('67440bce-44ca-4c57-9d0a-e6e8881a2997', '71712d42-c574-46cf-826e-f76db3a9749f', 'Expired', false),
        ('c0df2424-327b-4220-b6bd-add4dc58fd92', '71712d42-c574-46cf-826e-f76db3a9749f', 'Doesn''t appear to be genuine (e.g. not an original document, missing security feature)', false),
        ('dbd486a9-e3b5-4fe1-a0ba-0a7682422684', '71712d42-c574-46cf-826e-f76db3a9749f', 'Not an acceptable document', false);
    ...
    INSERT INTO public.review_question_options (id, review_question_id, text, valid) VALUES
        ('357a3e84-8376-4594-ab3f-a6b8c436c2da', '676fac34-b6e5-4cff-b523-0a4bbc7bca88', 'Yes I am confident', true),
        ('6fea484e-c28e-45b2-ab38-a84a4790eefa', '676fac34-b6e5-4cff-b523-0a4bbc7bca88', 'Possible suspicious activity', false),
        ('d2d4ec17-dff5-4ece-8923-44f6130d195f', '676fac34-b6e5-4cff-b523-0a4bbc7bca88', 'Not confident enough to verify for other reason', false);
