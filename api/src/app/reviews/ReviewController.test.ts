...
describe('ReviewController', () => {
  ...
  describe('finishReviewNoId', () => {
    it('accepts data', async () => {
      const reviewId = '532bd3f4-a0c5-4a97-87a9-19d46981747c'
      const reviewer: TD.DBReviewer = {
        id: '837954a6-4ff2-449a-ac0b-35b9883fe1ec',
        email: 'test@example.co.uk',
        full_name: 'Admin User',
      ...
      await expect(
        new ReviewController().finishReview({ user: reviewer }, reviewId, {
          status: 'APPROVED',
          answers: reviewAnswers,
        }),
      ).rejects.toThrowError(
        `No connection id found for review 532bd3f4-a0c5-4a97-87a9-19d46981747c, unable to issue credential`,
      )
    })
  })
})
